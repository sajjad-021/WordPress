...
if (! function_exists('mfn_builder_enqueue')) {
	...
	{
		wp_enqueue_style('mfn-builder', get_theme_file_uri('/functions/builder/css/style.css'), false, time(), 'all');
		wp_enqueue_script('mfn-builder', get_theme_file_uri('/functions/builder/js/scripts.js'), array('jquery'), time(), true);
	}
}
