...
<div class="nsl-admin-sub-content">
    ...
    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" novalidate="novalidate">
        ...
        <table class="form-table">
            <tbody>
            <tr>
                <th scope="row"><label for="application_id"><?php _e('Application ID', 'nextend-facebook-connect'); ?></label>
                ...
                <td>
                    ...
                    <p class="description"
                       id="tagline-application_id"><?php printf(__('If you are not sure what is your %1$s, please head over to <a href="%2$s">Getting Started</a>', 'nextend-facebook-connect'), 'Application ID', $this->getUrl()); ?></p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label
                            for="secure_key"><?php _e('Secure key', 'nextend-facebook-connect'); ?></label>
