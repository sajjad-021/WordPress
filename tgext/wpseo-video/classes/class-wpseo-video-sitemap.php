...
class WPSEO_Video_Sitemap {
	...
	public function admin_panel() {
		...
		if ( isset( $_POST['reindex'] ) ) {
			...
			<div class="submit">
			<?php
			// WPSEO_Admin_Settings_Changed_Listener was introduced in Yoast SEO 12.3.
			if ( class_exists( 'WPSEO_Admin_Settings_Changed_Listener' ) ) {
				$settings_changed_listener = new WPSEO_Admin_Settings_Changed_Listener(); ?>
				<div id="wpseo-submit-container">
					<div id="wpseo-submit-container-float" class="wpseo-admin-submit">
						<input type="submit" class="button button-primary" name="submit" value="<?php esc_attr_e( 'Save Settings', 'yoast-video-seo' ); ?>"/>
					<?php $settings_changed_listener->show_success_message(); ?>
					</div>
					<div id="wpseo-submit-container-fixed" class="wpseo-admin-submit wpseo-admin-submit-fixed" style="display: none;">
						<input type="submit" class="button button-primary" name="submit" value="<?php esc_attr_e( 'Save Settings', 'yoast-video-seo' ); ?>"/>
						<?php $settings_changed_listener->show_success_message(); ?>
					</div>
				</div>
				...
				echo '<input type="submit" class="button button-primary" name="submit" value="' . esc_attr( 'Save Settings', 'yoast-video-seo' ) . '"/>';
			} ?>
			</div>
			</form>
