...
return array( 
		...
		'postal_field_enabled' => array( 
				...
				'default' => 'yes', 'value' => 'yes', 
				'desc_tip' => true, 
				'description' => __ ( 'Checkout page only: If enabled, the postal code field on the credit card form will be used in place of the WooCommerce billing postal code value. Your Braintree control panel AVS settings will determine if a postal code is rendered on the credit card form.', 'woo-payment-gateway' ), 
				'custom_attributes' => array( 
						'data-show-if' => array( 
								'form_type' => 'custom_form' 
						) 
