...
function wc_braintree_get_error_messages() {
	return apply_filters ( 'wc_braintree_get_error_messages', array( 
			...
			'PAYPAL_MERCHANT_ACCOUNT_EMPTY' => sprintf ( __ ( 'PayPal requires that you configure your merchant accounts. Navigate to the Advanced Settings page and click %sImport Accounts%s.', 'woo-payment-gateway' ), '<strong>', '</strong>' ), 
