...
class WC_Braintree_Payment_Method_Conversion {
	...
	public static function sync_payment_method_tokens($user_id, $env) {
		...
		$next_update = get_user_meta ( $user_id, 'wc_braintree_token_check', true );
