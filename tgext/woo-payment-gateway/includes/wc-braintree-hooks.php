...
add_filter ( 'woocommerce_get_customer_payment_tokens', 'wc_braintree_filter_customer_payment_tokens', 10, 3 );
 ...
 * **** Template Hooks *****
 */
add_action ( 'woocommerce_proceed_to_checkout', 'wc_braintree_cart_checkout_template', 1 );
