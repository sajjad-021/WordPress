...
if (!class_exists('DUP_PRO_Web_Services')) {
    ...
    class DUP_PRO_Web_Services
    {
         ...
         * @return void
         */
        public function duplicator_pro_package_scan_shutdown() {
            $logMessage = DUP_PRO_Handler::getVarLog();
            if (!empty($logMessage)) {
                DUP_PRO_Log::error($logMessage);
            }
        }
        ...
        function duplicator_pro_package_scan($not_ajax_call = false)
        {
            ...
            register_shutdown_function(array($this, 'duplicator_pro_package_scan_shutdown'));
