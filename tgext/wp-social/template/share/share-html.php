...
<div class="xs_social_share_widget <?php echo esc_attr($className);?>">
	<ul class="xs_share_url <?php echo  esc_attr($widget_style); ?> <?php echo (!isset($global_data['show_counter']['enable'])) ? 'wslu-social-counter' : ''; ?> <?php echo !isset($global_data['show_label']['enable']) && !isset($global_data['show_label']['enable']) ?  'wslu-both-text-label' : ''; ?>">
		<?php
