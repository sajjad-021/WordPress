...
?>
	<a href='#' class='button-primary' id='mbp-new-post'>+ <?php 
...
?></label></th>
						<td>		
							<input type='text' id='button_url' name='mbp_button_url' style='width:100%' />
							<br /><span class='description'><?php 
_e( 'Optional. Where the user should go when clicking the button. Leave empty to send them to your newly created WordPress post.', 'post-to-google-my-business' );
?></span>
						</td>
					</tr>				
...
?>
            ...
            <a href='#' class='button' id='mbp-cancel-post'><?php 
_e( 'Cancel', 'post-to-google-my-business' );
?></a>
			<button class='button' id='mbp-draft-post'><?php 
_e( 'Save draft', 'post-to-google-my-business' );
?></button>
			<button class='button-primary' id='mbp-publish-post'><?php 
...
_e( 'Post date', 'post-to-google-my-business' );
?></th> 
			<th class="manage-column column-postbusiness" scope="col"><?php 
_e( 'Business', 'post-to-google-my-business' );
?></th> 
