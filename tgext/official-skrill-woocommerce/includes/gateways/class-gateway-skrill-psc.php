...
class Gateway_Skrill_PSC extends Skrill_Payment_Gateway {
	 ...
	 * @var array
	 */
	protected $allowed_countries = array( 'ASM', 'AUT', 'BEL', 'CAN', 'HRV', 'CYP', 'CZE', 'DNK', 'FIN', 'FRA', 'DEU', 'GUM', 'HUN', 'IRL', 'ITA', 'LVA', 'LUX', 'MLT', 'MEX', 'NLD', 'MNP', 'NOR', 'POL', 'PRT', 'PRI', 'ROU', 'SVK', 'SVN', 'ESP', 'SWE', 'CHE', 'TUR', 'GBR', 'USA', 'VIR' );
