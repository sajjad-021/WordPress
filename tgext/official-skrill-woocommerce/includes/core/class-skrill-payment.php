...
class Skrill_Payment {
	 ...
	 * @return boolean
	 */
	public static function is_fraud( $amount, $order_id, $transaction_id, $anti_fraud_hash ) {
		return ! ( self::generate_anti_fraud_hash( $amount, $order_id, $transaction_id ) === $anti_fraud_hash );
	}
	 ...
	 * @return boolean
	 */
	public static function generate_anti_fraud_hash( $amount, $order_id, $transaction_id ) {
		return md5( $amount . $order_id . $transaction_id . 'skrill' );
	}
